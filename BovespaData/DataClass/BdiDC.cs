...
namespace BovespaData.DataClass
{
    public class BdiDC
    {
        ...
        protected Entidade.BDI.BdiFileState LoadFile(string path)
        {
            Entidade.BDI.BdiFileState flatFile = new Entidade.BDI.BdiFileState();
        ...
        private Entidade.BDI.HeaderState ReadHeader(string line)
        {
            ...
            BovespaData.DataClass.Entidade.BDI.HeaderState header = new BovespaData.DataClass.Entidade.BDI.HeaderState();
        ...
        private Entidade.BDI.IndiceState ReadIndice(string line)
        {
            BovespaData.DataClass.Entidade.BDI.IndiceState indice = new BovespaData.DataClass.Entidade.BDI.IndiceState();
        ...
        private Entidade.BDI.CotacaoState ReadCotacao(string line)
        {
            BovespaData.DataClass.Entidade.BDI.CotacaoState cotacao = new BovespaData.DataClass.Entidade.BDI.CotacaoState();
        ...
        private Entidade.BDI.ResumoBdiState ReadResumoPorCodBdi(string line)
        {
            Entidade.BDI.ResumoBdiState resumoPorCodBdi = new Entidade.BDI.ResumoBdiState();
        ...
        private Entidade.BDI.MaiorOscilacaoVistaState ReadMaiorOscilacaoAvista(string line)
        {
            BovespaData.DataClass.Entidade.BDI.MaiorOscilacaoVistaState maiorOscilaAvista = new BovespaData.DataClass.Entidade.BDI.MaiorOscilacaoVistaState();
        ...
        private Entidade.BDI.MaiorOscilacaoIbovState ReadMaiorOscilacaoIbov(string line)
        {
            BovespaData.DataClass.Entidade.BDI.MaiorOscilacaoIbovState maiorOscilaIbov = new BovespaData.DataClass.Entidade.BDI.MaiorOscilacaoIbovState();
        ...
        private Entidade.BDI.MaisNegociadasVistaState ReadMaisNegociadasAVista(string line)
        {
            BovespaData.DataClass.Entidade.BDI.MaisNegociadasVistaState maisNegocVista = new BovespaData.DataClass.Entidade.BDI.MaisNegociadasVistaState();
        ...
        private Entidade.BDI.MaisNegociadasState ReadMaisNegociadas(string line)
        {
            BovespaData.DataClass.Entidade.BDI.MaisNegociadasState maisNegoc = new BovespaData.DataClass.Entidade.BDI.MaisNegociadasState();
        ...
        private BovespaData.DataClass.Entidade.BDI.ResumoDiarioIopvState ReadIopv(string line)
        {
            BovespaData.DataClass.Entidade.BDI.ResumoDiarioIopvState iopv = new BovespaData.DataClass.Entidade.BDI.ResumoDiarioIopvState();
        ...
        private BovespaData.DataClass.Entidade.BDI.BdrState ReadBdr(string line)
        {
            BovespaData.DataClass.Entidade.BDI.BdrState bdr = new BovespaData.DataClass.Entidade.BDI.BdrState();
        ...
        private BovespaData.DataClass.Entidade.BDI.TrailerState ReadTrailer(string line)
        {
            BovespaData.DataClass.Entidade.BDI.TrailerState trailer = new BovespaData.DataClass.Entidade.BDI.TrailerState();
